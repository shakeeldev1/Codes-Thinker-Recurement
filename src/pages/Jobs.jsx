...
// Enhanced jobs data with more professional structure
...
const Jobs = () => {
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50/30 to-indigo-50/30">
            {/* Enhanced Header */}
            <header className="relative bg-gradient-to-r from-[#060145] via-[#0c047e] to-[#060145] text-white py-20 overflow-hidden">
                ...
                <div className="absolute bottom-0 right-0 w-96 h-96 bg-indigo-400/10 rounded-full translate-x-1/3 translate-y-1/3"></div>
            </header>

            {/* Main Content */}
            <main className="max-w-7xl mx-auto px-4 py-12 -mt-8 relative">
                {/* Search and Filters Section */}
                <div className="mb-12 rounded-3xl shadow-xl border border-gray-100 p-8 backdrop-blur-sm bg-white/95">
                    {/* Search Bar */}
                    <div className="mb-6">
                        <div className="relative max-w-2xl mx-auto">
                            ...
                            <input
                                ...
                                className="w-full pl-12 pr-4 py-4 bg-gray-50 border-2 border-[#1d158b] rounded-2xl focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200 hover:border-gray-300"
                            />
                        </div>
                    </div>
                    ...
                    <div className="flex justify-center mb-6">
                        <button
                            ...
                            className="flex items-center gap-2 px-6 py-3 text-white bg-[#060145] rounded-xl hover:bg-blue-950 transition-colors duration-200 font-medium"
                        >
                    ...
                    {/* Expandable Filters */}
                    {showFilters && (
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 pt-6 border-t border-gray-200 animate-fadeIn">
                            <div>
                                ...
                                <select
                                    ...
                                    className="w-full px-4 py-3 bg-gray-50 border-2 border-gray-200 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200"
                                >
                ...
                {filteredJobs.length === 0 && (
                    <div className="text-center py-16">
                        ...
                        <button
                            onClick={() => {
                                setSearchTerm("");
                                setFilters({ type: "all", experience: "all", location: "all", category: "all" });
                            }}
